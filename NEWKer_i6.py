...
exec("from v" + version_str + ".NEWKer_i6 import RobotPost as BasePost")

class RobotPost(BasePost):

    # ------------------------ Customize your RoboDK post processor using the following variables ------------------------

    PROG_EXT = "txt"    # : Set the output program extension

    MAX_LINE_LENGTH = 500    # : Maximum length of a line of code, in characters
...
if __name__== "__main__":
    exec("from v" + version_str + ".NEWKer_i6 import test_post")
    test_post()
