...
exec("from v" + version_str + ".KUKA_IIWA import RobotPost as BasePost")

class RobotPost(BasePost):

    # ------------------------ Customize your RoboDK post processor using the following variables ------------------------

    # Generate Spline movements instead of LIN movements
    MOVE_Spline = False

    # Default blend radius for LIN movements
    BLENDING_MM = 1
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_IIWA import test_post")
    test_post()
