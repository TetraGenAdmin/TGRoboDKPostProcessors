...
#   KUKA KRC2 DAT Arc robot controllers
#
...
exec("from v" + version_str + ".KUKA_KRC2_DAT_Arc import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_KRC2_DAT_Arc import test_post")
    test_post()
