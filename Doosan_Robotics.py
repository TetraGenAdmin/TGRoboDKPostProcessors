...
#   Doosan Robotics robot controllers
#
...
exec("from v" + version_str + ".Doosan_Robotics import RobotPost as BasePost")
...
class RobotPost(BasePost):
    ...
    PROG_EXT = "drl"    # set the program extension

    BLEND_RADIUS = -1    # default blend radius in meters (corners smoothing)
...
if __name__== "__main__":
    exec("from v" + version_str + ".Doosan_Robotics import test_post")
    test_post()
