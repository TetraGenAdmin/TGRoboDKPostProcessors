...
#   KUKA IIWA Spline robot controllers
#
...
exec("from v" + version_str + ".KUKA_IIWA_Spline import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_IIWA_Spline import test_post")
    test_post()
