...
#   KUKA KRC4 Slow robot controllers
#
...
exec("from v" + version_str + ".KUKA_KRC4_Slow import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_KRC4_Slow import test_post")
    test_post()
