...
#   Motoman CartesianOnly robot controllers
#
...
exec("from v" + version_str + ".Motoman_CartesianOnly import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Motoman_CartesianOnly import test_post")
    test_post()
