...
#   Staubli VAL3 Machining robot controllers
#
...
exec("from v" + version_str + ".Staubli_VAL3_Machining import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Staubli_VAL3_Machining import test_post")
    test_post()
