...
#   Techman FerRobotics robot controllers
#
...
exec("from v" + version_str + ".Techman_FerRobotics import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Techman_FerRobotics import test_post")
    test_post()
