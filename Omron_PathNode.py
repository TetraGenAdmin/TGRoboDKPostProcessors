...
#   Omron PathNode robot controllers
#
...
exec("from v" + version_str + ".Omron_PathNode import RobotPost as BasePost")
...
class RobotPost(BasePost):
    ...
    # Set default PLinear Speed A Velocity (PLSAVelocity)
    PLSAVELOCITY = 250

    # Set default PLinear Speed Time To Top Speed (PLSTTTS)
    PLSTTTS = 150
    ...
    # Set default robot configuration (Config)
    ROB_CONFIG = "0,2,4"
    ...
    # Set generated program as a .path file
    USE_PATH_NODE = False

    # Set the name of the default .path file
    PATH_NODE_NAME = "RoboDKPath"

    # Set .path node motion type to PLine (recommanded state: True)
    USE_PATH_PLINE = True
...
if __name__== "__main__":
    exec("from v" + version_str + ".Omron_PathNode import test_post")
    test_post()
