...
#   Dobot Magician robot controllers
#
...
exec("from v" + version_str + ".Dobot_Magician import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Dobot_Magician import test_post")
    test_post()
