...
#   Elite Robots EC movE robot controllers
#
...
exec("from v" + version_str + ".Elite_Robots_EC_movE import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Elite_Robots_EC_movE import test_post")
    test_post()
