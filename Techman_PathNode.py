...
#   Techman PathNode robot controllers
#
...
exec("from v" + version_str + ".Techman_PathNode import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Techman_PathNode import test_post")
    test_post()
