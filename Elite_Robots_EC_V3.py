...
#   Elite Robots EC V3 robot controllers
#
...
exec("from v" + version_str + ".Elite_Robots_EC_V3 import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Elite_Robots_EC_V3 import test_post")
    test_post()
