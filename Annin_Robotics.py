...
#   Annin Robotics robot controllers
#
...
exec("from v" + version_str + ".Annin_Robotics import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Annin_Robotics import test_post")
    test_post()
