...
#   Staubli Adept Vplus robot controllers
#
...
exec("from v" + version_str + ".Staubli_Adept_Vplus import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Staubli_Adept_Vplus import test_post")
    test_post()
