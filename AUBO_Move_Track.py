...
#   AUBO Move Track robot controllers
#
...
exec("from v" + version_str + ".AUBO_Move_Track import RobotPost as BasePost")
...
class RobotPost(BasePost):
    ...
    # Choose to use move_track for smooth movements using a CSV/RECT file
    USE_MOVE_TRACK = True

    # Set to 10 to force output joints at 10Hz rate (one value every 100 ms)
    USE_MOVE_TRACK_HZ_RATE = 10
...
if __name__== "__main__":
    exec("from v" + version_str + ".AUBO_Move_Track import test_post")
    test_post()
