...
exec("from v" + version_str + ".KUKA_CNC import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_CNC import test_post")
    test_post()
