...
#   Universal Robots Sync robot controllers
#
...
exec("from v" + version_str + ".Universal_Robots_Sync import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Universal_Robots_Sync import test_post")
    test_post()
