...
#   Siemens 840D PKM robot controllers
#
...
exec("from v" + version_str + ".Siemens_840D_PKM import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Siemens_840D_PKM import test_post")
    test_post()
