...
#   KUKA EntertainTech robot controllers
#
...
exec("from v" + version_str + ".KUKA_EntertainTech import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_EntertainTech import test_post")
    test_post()
