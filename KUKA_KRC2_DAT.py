...
#   KUKA KRC2 DAT robot controllers
#
...
exec("from v" + version_str + ".KUKA_KRC2_DAT import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_KRC2_DAT import test_post")
    test_post()
