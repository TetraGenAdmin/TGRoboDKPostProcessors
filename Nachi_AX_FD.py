...
exec("from v" + version_str + ".Nachi_AX_FD import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Nachi_AX_FD import test_post")
    test_post()
