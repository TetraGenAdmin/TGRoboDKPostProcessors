...
exec("from v" + version_str + ".Omron import RobotPost as BasePost")
...
class RobotPost(BasePost):
    ...
    # Set to True to adjust speeds for a remote TCP setup
    REMOTE_TCP_SPEED = False
    ...
    # Flag to include all init messages in one Display Node
    INIT_MESSAGE = None
...
if __name__== "__main__":
    exec("from v" + version_str + ".Omron import test_post")
    test_post()
