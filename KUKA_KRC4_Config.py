...
#   KUKA KRC4 Config robot controllers
#
...
exec("from v" + version_str + ".KUKA_KRC4_Config import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".KUKA_KRC4_Config import test_post")
    test_post()
