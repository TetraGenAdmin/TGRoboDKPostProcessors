...
#   RoboDK Python API robot controllers
#
...
exec("from v" + version_str + ".RoboDK_Python_API import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".RoboDK_Python_API import test_post")
    test_post()
