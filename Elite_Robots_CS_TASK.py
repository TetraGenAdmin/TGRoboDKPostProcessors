...
#   Elite Robots CS TASK robot controllers
#
...
exec("from v" + version_str + ".Elite_Robots_CS_TASK import RobotPost as BasePost")
...
if __name__== "__main__":
    exec("from v" + version_str + ".Elite_Robots_CS_TASK import test_post")
    test_post()
